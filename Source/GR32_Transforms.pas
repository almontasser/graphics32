...
{$IFDEF COMPILER2009_UP}
  OutputDebugString(PChar(Format('TRadialDistortionTransformation.PrepareReverseMap: MinValue(Map)=%f MaxValue(Map)=%f', [ MinValue(TArrayOfDouble(Map)), MaxValue(TArrayOfDouble(Map)) ])));
{$ENDIF}
{$ENDIF}
end;
